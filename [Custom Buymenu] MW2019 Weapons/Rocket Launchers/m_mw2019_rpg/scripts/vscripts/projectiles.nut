...
if (proj_lmm == null)
{
	...
	EntFireByHandle(proj_lmm, "AddOutput", "OnUser1 worldspawn:RunScriptCode:MIGI_ProjectileCheck():0:-1", 0, null, null)
	EntFireByHandle(proj_lmm, "AddOutput", "OnUser2 worldspawn:RunScriptCode:MIGI_MolotovCheck():0:-1", 0, null, null)
	EntFireByHandle(proj_lmm, "AddOutput", "OnUser3 worldspawn:RunScriptCode:MIGI_LungeCheck():0:-1", 0, null, null)
...
if (proj_timer == null)
{
	...
	EntFireByHandle(proj_timer, "AddOutput", "OnTimer worldspawn:RunScriptCode:MIGI_ProjectileWpnCheck():0:-1", 0, null, null)
